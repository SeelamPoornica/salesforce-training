...
1. **Welcome Email to Couple:** Automatically send a brochure and price list when a new **Lead** (inquiry) is created.
2. **Payment Milestone Reminder:** Send an automated email to the couple 10 days before their next payment is due.
